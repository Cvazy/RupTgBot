...
contact_info = {
    ...
    'Машиностроения' : 'Декан факультета: Евгений Владимирович Сафонов\n'
    'кандидат технических наук\n'
    '+7 (495) 223-05-23 доб. 2231\n'
    'fm@mospolytech.ru\n'
    'Заместитель декана по научной работе: Типалин Сергей Александрович\n'
    ...
    'Заместитель декана: Ермолаев Андрей Евгеньевич\n' 
    'erand@yandex.ru\n'
    'ул. Автозаводская, 16, ауд. АВ-1705\n'
    'Заместитель декана: Некрасов Дмитрий Анатольевич\n'    
    'nekrasov55@yandex.ru\n'
    'ул. Автозаводская, 16, ауд. АВ-1705\n'
    'Заместитель декана: Буздалина Ирина Александровна\n'
    'i.a.buzdalina@mospolytech.ru\n'
    'ул. Автозаводская, 16, ауд. АВ-1613'
    'Помощник декана: Юрицына Анастасия Михайловна\n'
